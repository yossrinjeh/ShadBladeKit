...
class {$modelName}Request extends FormRequest
{
    ...
    private function updateSidebar($modelName, $routeName)
    {
        ...
        $icon = '<svg class="mr-3 h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>';
        
        $sidebarItem = "\n                @can('view {$routeName}')\n                <x-nav-link :href=\"route('{$routeName}.index')\" :active=\"request()->routeIs('{$routeName}.*')\" class=\"group flex items-center px-2 py-2 text-sm font-medium rounded-md\">\n                    {$icon}\n                    {{ __('" . Str::plural($modelName) . "') }}\n                </x-nav-link>\n                @endcan";
