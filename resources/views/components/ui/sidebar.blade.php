            ...
            <div class="flex-shrink-0 flex border-t p-4">
                <div class="flex items-center w-full">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                        ...
                        <div x-show="open" x-transition class="absolute bottom-full ltr:right-0 rtl:left-0 mb-2 w-48 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 z-50" style="display: none;">
                            <div class="py-1">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="block w-full ltr:text-left rtl:text-right px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        {{ __('ui.logout') }}
                                    </button>
                                </form>
                            </div>
